        ...
        bodyCell: withCtx(({ column, record }, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            if (column.dataIndex === "nickName") {
              _push2(`<div class="pointer"${_scopeId}>${ssrInterpolate(record.nickName)} <span class="sugar-grey fs12" style="${ssrRenderStyle({ borderRadius: "5px", padding: "1px 5px" })}"${_scopeId}>${ssrInterpolate(record.name)}</span></div>`);
            ...
            return [
              column.dataIndex === "nickName" ? (openBlock(), createBlock("div", {
                key: 0,
                class: "pointer",
              ...
              ], 8, ["onClick"])) : column.dataIndex === "status" ? (openBlock(), createBlock(unref(Tag), {
                key: 1,
                bordered: false,
                color: record.status === "active" ? "success" : "error"
              }, {
